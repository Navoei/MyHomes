...
public enum Lang {
    ...
    MANAGE_HOMES_INVITED_TO_SPECIFIED_HOME("managehomes_invitedtospecifiedhome", "&aThe player, %invited_player%, has been invited to the home %home%, which is owned by %homeowner%."),
